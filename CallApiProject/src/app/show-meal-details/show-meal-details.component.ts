...
export class ShowMealDetailsComponent implements OnInit {
  ...
  urlPage;
  check;
  constructor(private router:ActivatedRoute,private router2:Router,private serp:PictureService ,private ser:MealService,private serc:MealCategoriesService,private seru:UnitMeasureService, private serl:LevelService,private serUser:UserService, private _snackBar: MatSnackBar,private dialog:MatDialog) { 
    ...
    this.router.params.subscribe(parameters => {
      ...
      this.urlPage=window.location.toString()
}
